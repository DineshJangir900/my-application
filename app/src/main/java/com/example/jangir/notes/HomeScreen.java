...
public class HomeScreen extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int fragmentManager = getSupportFragmentManager().beginTransaction()
        ...
        String value = result.getString( "email","Data not found");
        String value2 = result.getString( "name","Data not found");
        Log.d("ddd",""+value);
        Log.d("ddd",""+value2);

        TextView txtProfileName = (TextView) navigationView.getHeaderView(0).findViewById(R.id.text_email);
        txtProfileName.setText(value);
        TextView textView = navigationView.getHeaderView(0).findViewById(R.id.text_name);
            ...
            Auth.GoogleSignInApi.signOut(mGoogleApiClient).setResultCallback(
                    new ResultCallback<Status>() {
                        ...
                        public void onResult(Status status) {
                            Intent intent = new Intent(HomeScreen.this,GoogleSignIn.class);
                            startActivity(intent);
                        }
                    });
        }
